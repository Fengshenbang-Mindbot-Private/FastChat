...
torchrun --nproc_per_node=$GPUS_PER_NODE --master_addr=$MASTER_ADDR --master_port=$MASTER_PORT train.py \
    ...
    --data_path /cognitive_comp/pankunhao/data/writing/sft_data/train.json \
    --eval_data_path /cognitive_comp/pankunhao/data/writing/sft_data/eval.json \
    --bf16 True \
    --output_dir /cognitive_comp/pankunhao/code/FastChat/model_ckpt/writing_0910 \
    --num_train_epochs 8 \

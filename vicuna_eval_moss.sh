...
python get_model_answer.py \
    --model-path /cognitive_comp/pankunhao/pretrained/moss-moon-003-sft/ \
    --model-id "moss" \
    --question-file /cognitive_comp/pankunhao/data/writing/eval_data/writing_sbs.jsonl \
    --answer-file /cognitive_comp/pankunhao/data/writing/eval_data/writing_sbs_ans_moss.jsonl \

...
python get_model_answer.py \
    --model-path /cognitive_comp/pankunhao/code/FastChat/model_ckpt/writing_0628/checkpoint-296 \
    --model-id "ziya_13b" \
    --question-file /cognitive_comp/pankunhao/data/writing/eval_data/writing_sbs.jsonl \
    --answer-file /cognitive_comp/pankunhao/data/writing/eval_data/writing_sbs_ans_8_0628_9.jsonl \
